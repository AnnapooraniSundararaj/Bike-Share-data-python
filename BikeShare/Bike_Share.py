...
def get_filters():
    ...
    while True:    
        month = input("Enter the name of the month from within first six months else type 'all'""\n")
        month = month.lower()
    ...
    while True:
        day = input("Enter the name of the week else type 'all'""\n")
        day = day.lower()
...
def time_stats(df):
    ...
    print("The most common weekday :", df['day_of_week'].mode()[0], "\n")
